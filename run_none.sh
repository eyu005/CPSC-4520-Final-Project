#!/usr/bin/env bash
#
#SBATCH --job-name=sugarscape_none
#SBATCH --array=0-99               # 100 seeds: 0 through 99
#SBATCH --output=slurm_logs/sugarscape_none_%A_%a.out
#SBATCH --error=slurm_logs/sugarscape_none_%A_%a.err
#SBATCH --time=01:00:00            # 5 hour per seed
...
# Set decision model to "none"
MODEL_NAME="none"

# Seed is just the array task ID
